# Celectric Website Redesign - Client Discussion

## Purpose
This file is for client-facing discussion, alignment, and confirmation.
Only include items that are suitable to share externally.
